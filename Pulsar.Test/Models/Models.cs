namespace Pulsar.Test.Models
{
	public static class TestConstantValues
	{
		...
		public static string NEW_DYNAMIC_TOPIC => $"public/default/{Guid.NewGuid()}"; // Changed to property
		public static string NEW_TOPIC_WITH_RETENTION => $"public/default/{Guid.NewGuid()}"; // Changed to property
